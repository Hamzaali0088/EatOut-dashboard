      ...
      <header className="border-b border-neutral-900/80 bg-black/80 backdrop-blur">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/signup"
              className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg bg-primary text-black text-xs font-semibold hover:bg-red-500 transition-colors"
            >
              Start free trial
        ...
        <section className="grid gap-10 md:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)] items-center mb-16">
          <div>
            ...
            <div className="flex flex-wrap gap-3 mb-6">
              <Link
                href="/signup"
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-primary text-black text-sm font-semibold hover:bg-red-500 transition-colors"
              >
                Start Free Trial
        ...
        <section id="how-it-works" className="mb-16">
          ...
          <ol className="space-y-4 text-xs text-neutral-300">
            <li className="flex gap-3">
              <span className="h-6 w-6 rounded-full bg-primary text-black flex items-center justify-center text-[11px] font-bold">
                1
              </span>
              <div>
        ...
        <section id="pricing" className="mb-16">
          ...
          <div className="grid gap-4 md:grid-cols-3 text-xs">
            ...
            <div className="rounded-2xl border border-primary bg-neutral-950 p-4 flex flex-col relative">
              <span className="absolute -top-2 right-3 px-2 py-0.5 rounded-full bg-primary text-black text-[10px] font-semibold">
                Most popular
              </span>
              ...
              <Link
                href="/signup"
                className="inline-flex items-center justify-center px-3 py-1.5 rounded-lg bg-primary text-black font-semibold hover:bg-red-500 transition-colors"
              >
                Start Professional
              </Link>
            </div>
