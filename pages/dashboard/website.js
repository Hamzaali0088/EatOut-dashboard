          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div className="flex items-start gap-3 flex-1">
              ...
              <div className="flex-1">
                <p className="text-xs font-semibold text-neutral-100 mb-1">Your Public Website</p>
                <p className="text-[11px] text-neutral-400 font-mono bg-black/40 px-2 py-1 rounded border border-neutral-800 inline-block">
                  {websiteUrl}
                </p>
            ...
            <div className="flex gap-2">
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-neutral-700 text-neutral-200 hover:bg-neutral-900 transition-colors text-xs"
              >
                {copied ? (
                  <>
              ...
              <button
                onClick={openWebsite}
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-primary text-black hover:bg-red-500 transition-colors text-xs font-semibold"
              >
      ...
      <div className="grid gap-4 md:grid-cols-[minmax(0,1.4fr)_minmax(0,1.6fr)]">
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-3 text-xs">
            ...
            <div className="space-y-1">
              <label className="text-neutral-300 text-[11px]">Description</label>
              <textarea
                rows={3}
            ...
            <div className="grid gap-2 md:grid-cols-2">
              <div className="space-y-1">
                <label className="text-neutral-300 text-[11px]">Logo URL</label>
                <input
                  type="text"
              ...
              <div className="space-y-1">
                <label className="text-neutral-300 text-[11px]">Banner URL</label>
                <input
                  type="text"
            ...
            <div className="grid gap-2 md:grid-cols-3">
              <div className="space-y-1">
                <label className="text-neutral-300 text-[11px]">Phone</label>
                <input
                  type="text"
              ...
              <div className="space-y-1">
                <label className="text-neutral-300 text-[11px]">Public website</label>
                <select
        ...
        >
          <div 
            className="rounded-xl border border-neutral-800 bg-neutral-950 overflow-hidden text-xs cursor-pointer hover:border-primary/50 transition-colors"
            onClick={openWebsite}
          ...
          >
            <div className="relative h-32">
              {settings.bannerUrl ? (
                ...
                <div className="h-full w-full bg-gradient-to-br from-primary/20 via-black to-black" />
              )}
              ...
              <div className="absolute left-4 bottom-3 flex items-center gap-3">
                {settings.logoUrl ? (
                  ...
                  <img
                    ...
                    alt="Logo"
                    className="h-10 w-10 rounded-lg object-cover border border-neutral-700 bg-neutral-900"
                  />
                ) : (
                  <div className="h-10 w-10 rounded-lg bg-primary text-black flex items-center justify-center text-sm font-bold">
                    {(settings.name || "R")[0]}
                  </div>
                )}
                <div>
            ...
            <div className="px-4 py-3 text-[11px] text-neutral-300 space-y-2">
