  ...
  return (
    <AdminLayout title="Restaurant Website">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div className="flex items-start gap-3 flex-1">
              ...
              <div className="flex-1">
                ...
                <p className="text-[11px] text-gray-700 dark:text-neutral-400 font-mono bg-gray-100 dark:bg-black/40 px-2 py-1 rounded border border-gray-300 dark:border-neutral-800 inline-block">
                  {websiteUrl}
                </p>
                <p className="text-[10px] text-gray-600 dark:text-neutral-500 mt-1">
                  {settings.isPublic
            ...
            <div className="flex gap-2">
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-gray-300 dark:border-neutral-700 text-gray-700 dark:text-neutral-200 hover:bg-gray-100 dark:hover:bg-neutral-900 transition-colors text-xs"
              >
                {copied ? (
                  <>
      ...
      <div className="grid gap-4 md:grid-cols-[minmax(0,1.4fr)_minmax(0,1.6fr)]">
        ...
        >
          <div
            className="rounded-xl border border-gray-200 bg-white dark:bg-neutral-950 overflow-hidden text-xs cursor-pointer hover:border-primary/50 transition-colors"
            onClick={openWebsite}
          ...
          >
              ...
              <div className="absolute left-4 bottom-3 flex items-center gap-3">
                {settings.logoUrl ? (
                  ...
                  <img
                    ...
                    alt="Logo"
                    className="h-10 w-10 rounded-lg object-cover border border-gray-200 dark:border-neutral-700 bg-white dark:bg-neutral-900"
                  />
                ) : (
            ...
            <div className="px-4 py-3 text-[11px] text-gray-700 dark:text-neutral-300 space-y-2 bg-white dark:bg-neutral-950">
